...
<div className="w-full min-h-screen bg-[#0b0b1e] bg-radial-[at_top_right] from-black/60 to-[#8686e9]  flex items-center justify-center px-6 py-20 relative overflow-hidden">
  ...
  {/* Background Glows */}
  <div className="absolute top-1/4 left-1/3 w-72 h-72 bg-[#7f7fe9] rounded-full blur-3xl pointer-events-none" />

  {/* Card */}
  <div className="relative z-10 w-full max-w-lg rounded-3xl bg-gray-700/90 backdrop-blur-xl border border-gray-800 px-15 py-10 shadow-2xl">
    ...
    <div className="flex items-center gap-3 mb-6">
      ...
      <h1 className="text-2xl font-bold text-white leading-tight">
        Sign up meet the Assistant that{" "}
  ...
  <form onSubmit={handleForm} className="flex flex-col justify-center items-center gap-5 w-full">

    <label htmlFor="name" className="w-full text-white font-medium">
      NAME
      <input
  ...
  <div className="relative w-full flex items-center mt-2">
    ...
    {showErr && <p className='text-red-400 font-bold  text-xl' > {showErr} </p> }
    ...
    >
      {loading ? 'Signing you...' : 'Sign up'}
    </button>
    <p className='text-xl ' > Already have an account <span onClick={()=>navigate('/login') }  className='text-white underline font-semibold cursor-pointer hover:text-indigo-400 ' > login here </span> </p>
